    ...
    public partial class Migration_1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.ProductCost", t => t.Cost, cascadeDelete: false)
                .ForeignKey("dbo.User", t => t.PersonId)
                .Index(t => t.PersonId)
                .Index(t => t.ProductId)
                .Index(t => t.Cost);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Transaction", "Cost", "dbo.ProductCost");
            ...
            DropIndex("dbo.Transaction", new[] { "Cost" });
